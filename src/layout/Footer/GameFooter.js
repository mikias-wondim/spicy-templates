            ...
            <div className="game-footer-right">
              ...
              <div className="game-award mb-4">
                ...
                <ul className="list-unstyled d-flex">
                  <li className="me-4">
                    <img src="/award-1.png" className="img-fluid" alt="award" />
                  </li>
                  <li className="me-4">
                    {" "}
                    <img src="/award-2.png" className="img-fluid" alt="award" />
                  </li>
                  <li>
                    <img src="/award-3.png" className="img-fluid" alt="award" />
                  </li>
                </ul>
              </div>
          ...
          <div className="row justify-content-between py-3">
            ...
            <div className="col-lg-6 col-md-6 col-sm-12">
              <div className="c-right text-md-end">
                <Link legacyBehavior href="/">
                  <a className="text-decoration-none text-white pe-4">
                    Privacy Policy
                  </a>
                </Link>
                <Link legacyBehavior href="/">
